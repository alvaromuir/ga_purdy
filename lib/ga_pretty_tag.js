...
(function() {
  module.exports = function(vars, googleId, website, cb) {
    var id, rslt, site, var1, var2, var3, var4, var5, var6, var7, x, y, _i, _len;
    if (!typeof args instanceof Array) {
      return "error - first argument must be an array";
    }
    for (y = _i = 0, _len = vars.length; _i < _len; y = ++_i) {
      x = vars[y];
      if (vars[y] === '') {
        vars[y] = 'var' + y;
      }
